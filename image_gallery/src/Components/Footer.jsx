import { AiFillFacebook, AiFillGithub, AiFillHome, AiFillLinkedin, AiFillPhone, AiOutlineInstagram, AiOutlineMail } from "react-icons/ai";
const Footer = () => {
    return (
        <>
            <div className="container-fluid my-2" style={{ backgroundColor: "black" }}>
                <footer className="text-center text-lg-start text-white">
                    <section className="d-flex justify-content-between p-4 text-white" style={{ backgroundColor: "rgb(162, 0, 255)" }}>
                        <div className="me-5">
                        ...
                        <div className="container text-center text-md-start mt-5">
                            <div className="row mt-3">
                                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                    ...
                                    <hr className="mb-4 mt-0 d-inline-block mx-auto"style={{ width: "130px", backgroundColor: "#7c4dff", height: "2px" }}/>
                                ...
                                <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    <hr className="mb-4 mt-0 d-inline-block mx-auto" style={{ width: "120px", backgroundColor: "#7c4dff", height: "2px" }}/>
                                    <p>
